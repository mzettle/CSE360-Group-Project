...
//Time: 92 hours
//Description: This is the create employee window. This will have the user enter in their username, password, first name, last name, email, and choose their position type. They have the option to press create, or back.
...
public class CreateEmployeeGUI extends JPanel  {
	...
	protected JLabel userName, password, header, fname, lname, email, positionJL;
	protected JComboBox positionCB;
	protected JButton back, create;
	protected JTextField uName, pWord, fnameTF,lnameTF, emailTF;
	...
	public CreateEmployeeGUI() {
		...
		// new JLabels
		//-------------------------------------
		header = new JLabel("Create Employee", SwingConstants.CENTER);
		...
		positionJL = new JLabel("Position: ", SwingConstants.CENTER);
		positionJL.setForeground(Color.black);
		positionJL.setFont(new Font("Time", Font.BOLD, 25));
		...
		// new JComboBox
		//-------------------------------------
		String positionS[] = { "Employee", "Manager" };
		...
		panel.add(email);
		panel.add(emailTF);
		panel.add(positionJL);
		panel.add(positionCB);
	...
	public static void CreateEmployeeGUIwindow() {
		new CreateEmployeeGUI();
	}// end CreateEmployeeGUIwindow
} // end class CreateEmployeeGUI
